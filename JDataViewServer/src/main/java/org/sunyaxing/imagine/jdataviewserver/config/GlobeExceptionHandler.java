...
public class GlobeExceptionHandler {
    ...
    public ResponseEntity<Result<String>> illegalArgumentExceptionHandler(IllegalArgumentException e) {
        log.error("参数错误：", e);
    ...
    public ResponseEntity<Result<String>> illegalArgumentExceptionHandler(RuntimeException e) {
        log.error("业务异常：", e);
